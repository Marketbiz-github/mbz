...
export default function ClientWABlastReportDetail({ params }: { params: Promise<{ reportId: string }> }) {
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-12 max-w-7xl mx-auto">
      <div className="flex items-center gap-4">
        <button 
          onClick={() => report ? router.push(`/client/wa-blast/detail/${report.project_id}`) : router.push('/client/wa-blast')}
                        ...
                        <tr key={rec.id} className="hover:bg-white/2 transition-colors">
                          ...
                          <td className="px-6 py-4 relative">
                            <div className="flex flex-col items-start gap-1">
                              <span 
                                className={cn("px-2 py-1 rounded flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider",
